...
export const statusesArr = ['Published', 'To Publish', 'To Be Fixed', 'To Review', 'Draft'];
...
export function generateRandomStatusId(taskIdStatus, currentStatusName) {
  const ids = Object.keys(taskIdStatus)
    .filter(id => taskIdStatus[id] !== currentStatusName);
