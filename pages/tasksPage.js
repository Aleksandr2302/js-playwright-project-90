...
export default class TaskPage{
  constructor(page){
    ...
    this.errorElement = this.page.locator('.Mui-error.MuiFormHelperText-contained');
    ...
    this.toReviewHeader = page.getByRole('heading', {name:'To Review', level: '6'});
    this.toBeFixedHeader = page.getByRole('heading', {name:'To Be Fixed', level: '6'});
    this.toPublishHeader = page.getByRole('heading', {name:'To Publish', level: '6'});
    this.publishedHeader = page.getByRole('heading', {name:'Published', level: '6'});
  }
...
////////////////////////////////////////////////////////////////////////////////////////////////////
// Create new task
  async createNewTasks(assigneeName, title,statusName,labelName = null, content = null){
...
////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  async createNewTaskWithoutMandatoryField(assigneeName){
    ...
    await expect(this.warningMessage).toHaveText('The form is not valid. Please check for errors');
  ...
  // Verify new task
  async newTasksVerification(assigneeName, title, statusName, labelName = null, content = null) {
  await this.gotoTaskWidget();
...
// Verify task was deleted
  async tasksDeletedVerification(assigneeName, title, statusName, labelName = null, content = null) {
  await this.gotoTaskWidget();
...
////////////////////////////////////////////////////////////////////////////////////////////////////
async moveTaskManually(assigneeName,titleName, statusName, labelName=null,content = null, newTaskId,newStatusName){
  await this.gotoTaskWidget();
...
////////////////////////////////////////////////////////////////////////////////////////////////////
async updateTaskInformation(assigneeNameOld,titleNameOld, statusNameOld, labelNameOld=null, assigneeNameNew,titleNameNew, statusNameNew, labelNameNew=null,contentNew) {
  await this.gotoTaskWidget();
...
////////////////////////////////////////////////////////////////////////////////////////////////////
async verifyShowButtonAndWindow(assigneeName,titleName, statusName, labelName=null, content = null) {
  await this.gotoTaskWidget();
...
// Verify show window 
await expect(this.page.getByRole('link', {name:`${assigneeName}`})).toBeVisible();
await expect(this.page.getByText(`${titleName}`, { exact: true })).toBeVisible();
if( content != null){
...
////////////////////////////////////////////////////////////////////////////////////////////////////
async deleteTaskFromShowWindow(assigneeName,titleName, statusName, labelName=null) {
  await this.gotoTaskWidget();
...
////////////////////////////////////////////////////////////////////////////////////////////////////
async cancelDeletionTaskFromShowWindow(assigneeName,titleName, statusName, labelName=null) {
  await this.gotoTaskWidget();
